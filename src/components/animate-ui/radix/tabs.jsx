...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn('rounded-full bg-blue-400 shadow-lg  ', activeClassName)}
      value={activeValue}
      ...
      <TabsPrimitive.List
        ...
        data-slot="tabs-list"
        className={cn(
          'bg-muted text-black  inline-flex  w-fit items-center justify-center my-1 font-poppins px-4 py-3 rounded-full',
          className
        )}
        {...props}>
        {children}
