...
const Contact = () => {
    return (
        <div className='flex max-sm:flex-col justify-center py-5 rounded-2xl bg-white gap-4'>
            ...
            <div className='flex justify-center md:w-3xl'>
                <Tabs className="w-full border border-black" defaultValue="Business">
                    ...
                    <TabsContents className="mx-10 bg-blue-200  mb-3 rounded-2xl h-full ">
                        <TabsContent value="Business" className="space-y-6 ">
                            <form className='px-10 border p-5'>
                                ...
                                <div className="mb-4  px-3">
                                    ...
                                    <input type="text" id='name' name='companyName' placeholder='Enter your Company name' className='my-1 w-full p-2 outline-2 rounded-[5px] outline-blue-300 placeholder:text-gray-500 placeholder:font-normal bg-white' />
                                </div>
                                <div className="px-3">
                                    <label htmlFor="promotionalActivity" className='flex items-center gap-3 font-poppins text-sm'><input class="accent-violet-800 w-4 h-4" type="checkbox" id='promotionalActivity' /> Enquiry for promotional activities</label>
                                </div>
                                <div className="mb-4  px-2">
